...
if (skyCanvas) {
  ...
  const starCount = extrasPhoneViewport.matches || extrasReducedMotion.matches ? 72 : 120;
  ...
  function drawSky(time = 0) {
    const animateSky = !extrasReducedMotion.matches;
  ...
  if (extrasReducedMotion.matches) {
    drawSky(0);
  } else {
